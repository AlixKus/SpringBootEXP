...
public class DemoDaoTest {
    ...
    public void saveDemoTest() {
        ...
        demoEntity.setBy("mcs");
        demoEntity.setUrl("http://www.MongoDB.com");
        ...
        demoEntity.setId(2L);
        demoEntity.setTitle("Spring Boot 中使用 MongoDB");
        demoEntity.setDescription("222");
        demoEntity.setBy("mcs");
        demoEntity.setUrl("http://www.spring.com");
    ...
    public void updateDemoTest() {
        ...
        demoEntity.setBy("mcs");
        demoEntity.setUrl("http://www.mcs.com");
